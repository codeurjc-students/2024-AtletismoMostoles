...
class AthletesE2ETest {
    ...
    void navigateToPage() {
        ...
        String expectedUrl = https+"ranking";
    ...
    void testNavigationLinks() {
        assertEquals(https, driver.findElement(By.linkText("Inicio")).getAttribute("href"));
        assertEquals(https+"miembros", driver.findElement(By.linkText("Miembros del Club")).getAttribute("href"));
        assertEquals(https+"ranking", driver.findElement(By.linkText("Ranking")).getAttribute("href"));
        assertEquals(https+"eventos", driver.findElement(By.linkText("Eventos")).getAttribute("href"));
        assertEquals(https+"calendario", driver.findElement(By.linkText("Calendario")).getAttribute("href"));
    }
    ...
    void testAddAndRemoveAthlete() {
        ...
        driver.findElement(By.xpath("//mat-option/span[contains(text(), 'Luis Díaz')]")).click();
        ...
        wait.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector("mat-option")));
        wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//mat-option/span[contains(text(), 'Jabalina')]")));
        wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//mat-option/span[contains(text(), 'Jabalina')]"))).click();
    ...
    void testFilterAthletes() {
        ...
        driver.findElement(By.cssSelector("input[name='licenseNumber']")).sendKeys("A001");
        driver.findElement(By.cssSelector("button[mat-raised-button][color='primary']")).click();
        ...
        while (true) {
            ...
            for (WebElement row : rows) {
                ...
                for (WebElement cell : cells) {
                    if (cell.getText().trim().equals(licenseNum)) {
                        cell.click();
