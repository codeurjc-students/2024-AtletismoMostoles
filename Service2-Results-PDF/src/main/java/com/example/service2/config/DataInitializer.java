    ...
    public void initData() {
        if (resultsRepository.count() == 0) {
            List<Result> results = List.of(
                    createResult("A001", 1L, 1L, "12.45"),
                    createResult("A002", 1L, 1L, "12.60"),
                    createResult("A001", 2L, 2L, "11.85"),
                    createResult("A003", 3L, 3L, "13.20"),
                    createResult("A004", 3L, 3L, "12.10"),
                    createResult("A002", 4L, 2L, "12.45"),
                    createResult("A002", 2L, 3L, "12.60"),
                    createResult("A004", 1L, 4L, "11.85"),
                    createResult("A003", 3L, 4L, "13.20"),
                    createResult("A005", 1L, 5L, "12.10")
            );
        ...
        if (pdfHistoryRepository.count() == 0) {
            List<PdfHistory> pdfs = List.of(
                    new PdfHistory("A001", "https://fake.url/pdf/atleta1-2024.pdf"),
                    new PdfHistory("A002", "https://fake.url/pdf/atleta2-2024.pdf"),
                    new PdfHistory("A004", "https://fake.url/pdf/atleta3-2024.pdf")
            );
            pdfHistoryRepository.saveAll(pdfs);
        }
    }

    private Result createResult(String athleteId, Long eventId, Long disciplineId, String value) {
